      ...
      <div className="space-y-4 md:space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            <h1 className="text-xl font-bold tracking-tight sm:text-2xl">Suppliers</h1>
            <p className="text-sm text-muted-foreground sm:text-base">Manage suppliers and view account statements</p>
          </div>
          
          <Button className="min-h-11 w-full sm:w-auto" onClick={() => setActiveTab("add")}>
                      ...
                      return (
                        ...
                        >
                          <div className="flex min-w-0 items-start gap-3">
                            <div className="shrink-0 rounded-full bg-teal-100 p-2 dark:bg-teal-900/30">
                              <Building2 className="h-5 w-5 text-teal-600 dark:text-teal-400" />
                            </div>
                            <div className="min-w-0 flex-1">
                              <h3 className="truncate font-medium leading-tight">{supplier.name}</h3>
                              <div className="mt-1 flex flex-col gap-1 text-xs text-muted-foreground sm:text-sm">
                                {supplier.phone && <span className="flex min-w-0 items-center gap-1 truncate">
                                  <Phone className="h-3 w-3" /> {supplier.phone}
                                </span>}
                                {supplier.email && <span className="flex min-w-0 items-center gap-1 truncate">
                          ...
                          <div className="mt-3 flex items-center justify-between gap-3 border-t pt-3">
                            ...
                            <p className="text-sm font-bold sm:text-base">{formatCurrency(statement?.totalPurchases || 0, "USD")}</p>
                            {statement && statement.balance > 0 && (
                              <Badge className="shrink-0 bg-amber-100 text-[10px] text-amber-800 dark:bg-amber-900 dark:text-amber-300 sm:text-xs">
